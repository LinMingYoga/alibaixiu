<?php
 ...
 $content_data = conn('select t1.*, t2.cat_name,t3.nickname,
...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="panel new">
        ...
        <?php foreach($content_data as $data){ ?>
          <div class="entry">
            <div class="head">
              <span class="sort"><?php echo $data['cat_name'] ?></span>
              <a href="javascript:;"><?php echo $data['title'] ?></a>
            </div>
            <div class="main">
              <p class="info"><?php echo $data['nickname'] ?> 发表于 <?php echo $data['created'] ?></p>
              <p class="brief"><?php echo $data['content'] ?></p>
              <p class="extra">
                <span class="reading">阅读(<?php echo $data['commentTotal'] ?>)</span>
                <span class="comment">评论(<?php echo $data['views'] ?>)</span>
                <a href="javascript:;" class="like">
                  <i class="fa fa-thumbs-up"></i>
                  <span>赞(<?php echo $data['likes'] ?>)</span>
                </a>
    ...
    <div class="footer clo-md-12">
      <p class="text-center">© 2016 XIU主题演示 本站主题由 themebetter 提供</p>
    </div>
  </div>
